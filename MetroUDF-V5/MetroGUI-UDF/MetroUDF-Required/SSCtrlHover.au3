...
Func _cHvr_Register($idCtrl, $fnHovOff = '', $fnHoverCb = '', $fnClick = '', $fnDblClk = '', $fHoverData = 0, $fClickData = 0)
	...
	$aData[4] = $fHoverData;Hover Off Data
	$aData[5] = $fnHoverCb;Hover ON func
	$aData[6] = $fHoverData;Hover ON Data
	$aData[9] = $fnClick;Click func
	$aData[10] = $fClickData; click data
	$aData[11] = $fnDblClk;DB click func
	$aData[12] = $fClickData;DB click data	
