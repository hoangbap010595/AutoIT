...
Local $ckCCloseForm = _Metro_CreateCheckbox("Refresh page after finish", 20, 205, 211, 25)
...
Func _stop()
	...
	_IEAction($oIE, "stop")
	_Metro_MsgBox(0, "Message", "Progress has stopped!",200,11,$Form1)
EndFunc   ;==>_stop
...
Func initBrowser()
;~ 	$oIE = _IECreate($urlAddress,0,1,1)
...
;~ 	Local $oForm = _IEGetObjByName($oIE, "f")
	...
	_Metro_MsgBox(0, "Message",'Form:' & @extended,400,11,$Form1)
